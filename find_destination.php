...
$id = angkadoang($_GET['destination']);

// buat prepared statements
$stmt = $db->prepare("SELECT COUNT(*) AS status_ada,nama_destination,deskripsi_destination,judul_caption_1,judul_caption_2,judul_caption_3,judul_card_1,judul_card_2,judul_card_3,isi_caption_1,isi_caption_2,isi_caption_3,isi_card_1,isi_card_2,isi_card_3 FROM destination WHERE id_destination = ?");
...
/* bind result variables */
    ...
    $stmt->bind_result($status_ada,$nama_destination, $deskripsi_destination,$judul_caption_1,$judul_caption_2,$judul_caption_3,$judul_card_1,$judul_card_2,$judul_card_3,$isi_caption_1,$isi_caption_2,$isi_caption_3,$isi_card_1,$isi_card_2,$isi_card_3);
    $stmt->fetch();
...
<div class="card">
    ...
    <div class="card-block">
        <!--Title-->
        <h4 class="card-title"><?php echo $judul_card_1; ?></h4>
        <!--Text-->
        <p class="card-text"><?php echo $isi_card_1; ?></p>
...
<div class="card">
    ...
    <div class="card-block">
        <!--Title-->
        <h4 class="card-title"><?php echo $judul_card_2; ?></h4>
        <!--Text-->
        <p class="card-text"><?php echo $isi_card_2; ?></p>
...
<div class="card">
    ...
    <div class="card-block">
        <!--Title-->
        <h4 class="card-title"><?php echo $judul_card_3; ?></h4>
        <!--Text-->
        <p class="card-text"><?php echo $isi_card_3; ?></p>
